        ...
        <div className="grid grid-cols-1 gap-7 items-end justify-items-center max-w-7xl w-full mx-auto md:grid-cols-2 lg:grid-cols-4">
          <div
            className={`sitecard z-10 col-span-1 !duration-300 active:outline-none lg:col-span-2 ${
              !scrollOver
                ? 'max-w-[calc(100%+3.5rem)] w-screen h-[calc(100vh+51px)] -mt-[calc(9rem+1px)] -mx-7 pb-[50px] bg-black border-none rounded-none md:max-w-[calc(200%+5.25rem)] md:-ml-7 md:-mr-[calc(100%+3.5rem)] lg:-mt-[calc(5rem+1px)]'
                : 'h-96 md:h-56'
            }`}
          >
            <Image
